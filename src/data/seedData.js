...
export const DEFAULT_CATEGORIES = [
  { name: '房間清潔', emoji: '🧹', color: '#1f7a6d' },
  { name: '氣味異味', emoji: '🌫️', color: '#9c6b4a' },
  { name: '地毯地板', emoji: '🟫', color: '#8a7355' },
  { name: '床品布草', emoji: '🛌', color: '#2e86ab' },
  { name: '浴室衛生', emoji: '🚿', color: '#4a6fa5' },
  { name: '馬桶廁所', emoji: '🚽', color: '#5b8fa5' },
  { name: '排水花灑', emoji: '🚰', color: '#3f9e9e' },
  ...
  { name: '工具', emoji: '🧰', color: '#54808c', for_complaints: false },
]
...
export const seedTopics = [
  // ── 房間 ──
  { category: '房間清潔', title: '床單四角拉緊標準', why: '床是客人進房第一眼看的地方，床單皺摺會令整間房顯得馬虎。', correct_steps: ['床單四角包緊床墊，中線對齊', '被套四角抖到位，被芯不打結', '枕頭袋開口朝外側統一方向'], mistakes: ['四角只塞不包，客人一坐就鬆', '被芯縮在一角'], supervisor_check: '抽查時掀開床尾角看包法', reminder: '「床鋪得好，房就好了一半。」', question: '鋪床時床單四角的標準是什麼？', answer: '四角包緊床墊、中線對齊，被芯抖到位不打結。' },
  { category: '房間清潔', title: '床底及沙發底檢查', why: '床底遺留物是最尷尬的投訴——客人會覺得房間根本沒有打掃過。', correct_steps: ['C/O房用手電筒照床底、沙發底、床頭櫃背面', '發現雜物立即清走並檢查是否遺留物'], mistakes: ['只吸看得見的地面', '以為上一班查過就跳過'], supervisor_check: 'C/O房抽查必照床底', reminder: '「看不見的地方，才是標準所在。」', question: 'C/O房哪三個位置必須用手電筒照？', answer: '床底、沙發底、床頭櫃背面。' },
  { category: '房間清潔', title: '杯具消毒與擺位', why: '杯具直接入口，衛生問題會直接變成投訴甚至衛生部門事件。', correct_steps: ['杯具收回工作間統一消毒', '消毒後戴手套拿杯身，不碰杯口', '杯墊、杯蓋按標準擺位'], mistakes: ['在房內用毛巾擦杯了事', '徒手碰杯口留下指紋'], supervisor_check: '抽查杯口有無水漬指紋', reminder: '「杯子是客人放到嘴邊的東西。」', question: '房間杯具應該在哪裡清潔？', answer: '收回工作間統一消毒，不可在房內用毛巾擦。' },
  { category: '房間清潔', title: '遙控器與電話消毒', why: '遙控器是全房細菌最多的物件，客人愈來愈關注。', correct_steps: ['每日用消毒濕巾擦遙控器、電話聽筒、電燈開關', '電話聽筒檢查有無異味'], mistakes: ['只擦表面不擦按鍵縫', '電話從不檢查'], supervisor_check: '抽查遙控器按鍵縫', reminder: '「客人手最常碰的，就要最乾淨。」', question: '全房細菌最多的物件是什麼？如何處理？', answer: '遙控器——每日用消毒濕巾連按鍵縫一起擦拭。' },
  { category: '房間清潔', title: '鏡面與窗台指紋', why: '鏡面有印客人一照就看見，觀感分立刻扣光。', correct_steps: ['鏡面用乾布打圈收尾', '窗台、玻璃檯面側光檢查'], mistakes: ['布太濕留水痕', '只正面看不側光看'], supervisor_check: '側光看鏡面及玻璃檯面', reminder: '「側身看一眼，勝過正面看三眼。」', question: '檢查鏡面和玻璃檯面的正確方法是什麼？', answer: '側光檢查，才容易看到指紋和水痕。' },
  // ── 浴室 ──
  { category: '浴室衛生', title: '排水口毛髮檢查', why: '一根毛髮足以令客人懷疑整間房的衛生。', correct_steps: ['沖洗後用紙巾檢查排水口蓋及四周', '撥開排水蓋檢查蓋底', '乾身後最後目視檢查'], mistakes: ['只沖水不檢查', '趕房跳過最後檢查'], supervisor_check: '每層抽查3間看排水口及地漏', reminder: '「客人是用一根頭髮，來評價整間房。」', question: '浴室清潔完成前，最後一步必須檢查哪個位置？', answer: '排水口——撥開蓋子檢查蓋底和四周有無毛髮。' },
  { category: '浴室衛生', title: '馬桶內緣與底座', why: '馬桶是衛生投訴的重災區，內緣與底座最容易遺漏。', correct_steps: ['刷內緣出水孔位置', '擦底座與地面接縫', '蓋板正反兩面都擦'], mistakes: ['只刷看得見的內壁', '底座接縫積垢無人理'], supervisor_check: '抽查用鏡子看馬桶內緣', reminder: '「馬桶乾淨，是衛生的底線。」', question: '刷馬桶最容易遺漏的兩個位置是哪裡？', answer: '內緣出水孔和底座與地面的接縫。' },
  { category: '浴室衛生', title: '浴巾布草污漬檢查', why: '有污漬的毛巾掛回架上，等於告訴客人「我們沒有檢查」。', correct_steps: ['布草上架前逐件打開檢查', '有污漬、破損、異味立即更換', '摺法統一，商標朝同一方向'], mistakes: ['整疊上架不逐件看', '污漬面朝內就當看不見'], supervisor_check: '抽查打開浴巾看兩面', reminder: '「每一條毛巾，都代表酒店。」', question: '布草上架前要做什麼？', answer: '逐件打開檢查兩面，有污漬破損異味立即更換。' },
  { category: '浴室衛生', title: '沐浴用品補充標準', why: '用品缺漏是最容易避免卻最常發生的投訴。', correct_steps: ['按房型清單逐格補齊', '瓶裝低於1/3即換', '標籤統一朝外'], mistakes: ['憑記憶補不核對清單', '瓶裝剩一點點就算了'], supervisor_check: '抽查對照備品清單', reminder: '「客人半夜發現沒有沐浴乳，就是投訴。」', question: '瓶裝用品剩多少就要更換？', answer: '低於三分之一即換，補品必須核對清單。' },
  { category: '浴室衛生', title: '地面乾身與防滑', why: '濕滑地面是安全事故源頭，跌倒是最嚴重的投訴類別。', correct_steps: ['清潔後地面擦乾至無水膜', '浴缸/淋浴間底部檢查防滑貼', '地巾擺放到位'], mistakes: ['等地面自然乾', '防滑貼發黑無人更換'], supervisor_check: '完房後踩測地面乾爽度', reminder: '「乾的地面，是最基本的安全。」', question: '完房時浴室地面的標準是什麼？', answer: '擦乾至無水膜、踩上去乾爽，地巾擺放到位。' },
  // ── 服務 ──
  ...
  { category: '服務', title: '客人在房時的清潔禮儀', why: '客人在房時的一舉一動都被看在眼裡。', correct_steps: ['先詢問是否方便清潔', '動作放輕、不接聽私人電話', '客人物品原位不動'], mistakes: ['當客人不存在大聲操作', '擅自移動客人物品「整理美觀」'], supervisor_check: '留意住客房清潔時的禮儀表現', reminder: '「客人在場，你就是酒店的臉。」', question: '客人在房時清潔要注意什麼？', answer: '先詢問是否方便、動作放輕、客人物品原位不動。' },
...
export const TRAINING = [
  ...
  { emoji: '🌙', title: 'Stayover 程序', intro: '住房間的分寸：', steps: ['客人物品原位不動', '私人文件、財物不觸碰', '床鋪整理、毛巾按使用情況更換', '發現異常（損壞/違禁品）立即報主管'] },
...
export function seedComplaints() {
  ...
  return [
    ...
    row(-9, '1502', '房間', '床底有前住客的襪子', 'C/O房未做床底檢查', 'C/O房必須用手電筒照床底及沙發底', '已於早會分享', { shared: true }),
