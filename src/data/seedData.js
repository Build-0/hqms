...
export const seedTopics = [
  // ── 房間 ──
  { category: '房間', title: '床單四角拉緊標準', why: '床是客人進房第一眼看的地方，床單皺摺會令整間房顯得馬虎。', correct_steps: ['床單四角包緊床墊，中線對齊', '被套四角抖到位，被芯不打結', '枕頭袋開口朝外側統一方向'], mistakes: ['四角只塞不包，客人一坐就鬆', '被芯縮在一角'], supervisor_check: '抽查時掀開床尾角看包法', reminder: '「床鋪得好，房就好了一半。」', question: '鋪床時床單四角的標準是什麼？', answer: '四角包緊床墊、中線對齊，被芯抖到位不打結。' },
  { category: '房間', title: '床底及沙發底檢查', why: '床底遺留物是最尷尬的投訴——客人會覺得房間根本沒有打掃過。', correct_steps: ['C/O房用手電筒照床底、沙發底、床頭櫃背面', '發現雜物立即清走並檢查是否遺留物'], mistakes: ['只吸看得見的地面', '以為上一班查過就跳過'], supervisor_check: 'C/O房抽查必照床底', reminder: '「看不見的地方，才是標準所在。」', question: 'C/O房哪三個位置必須用手電筒照？', answer: '床底、沙發底、床頭櫃背面。' },
  { category: '房間', title: '杯具消毒與擺位', why: '杯具直接入口，衛生問題會直接變成投訴甚至衛生部門事件。', correct_steps: ['杯具收回工作間統一消毒', '消毒後戴手套拿杯身，不碰杯口', '杯墊、杯蓋按標準擺位'], mistakes: ['在房內用毛巾擦杯了事', '徒手碰杯口留下指紋'], supervisor_check: '抽查杯口有無水漬指紋', reminder: '「杯子是客人放到嘴邊的東西。」', question: '房間杯具應該在哪裡清潔？', answer: '收回工作間統一消毒，不可在房內用毛巾擦。' },
  { category: '房間', title: '遙控器與電話消毒', why: '遙控器是全房細菌最多的物件，客人愈來愈關注。', correct_steps: ['每日用消毒濕巾擦遙控器、電話聽筒、電燈開關', '電話聽筒檢查有無異味'], mistakes: ['只擦表面不擦按鍵縫', '電話從不檢查'], supervisor_check: '抽查遙控器按鍵縫', reminder: '「客人手最常碰的，就要最乾淨。」', question: '全房細菌最多的物件是什麼？如何處理？', answer: '遙控器——每日用消毒濕巾連按鍵縫一起擦拭。' },
  { category: '房間', title: '鏡面與窗台指紋', why: '鏡面有印客人一照就看見，觀感分立刻扣光。', correct_steps: ['鏡面用乾布打圈收尾', '窗台、玻璃檯面側光檢查'], mistakes: ['布太濕留水痕', '只正面看不側光看'], supervisor_check: '側光看鏡面及玻璃檯面', reminder: '「側身看一眼，勝過正面看三眼。」', question: '檢查鏡面和玻璃檯面的正確方法是什麼？', answer: '側光檢查，才容易看到指紋和水痕。' },
  // ── 浴室 ──
